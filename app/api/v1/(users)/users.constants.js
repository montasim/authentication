/**
 * @fileoverview This file defines various constants used for validating and managing (users)-related data.
 ...
 * These constants ensure that the (users) data conforms to the required formats and constraints for various operations in the application.
 */

/**
 * Length constraints for various (users)-related fields.
 *
 * @constant
 * @type {Object}
...
/**
 * Regex patterns for validating various (users)-related fields.
 *
 * @constant
 * @type {Object}
...
const pattern = {
     ...
     * - (users)@name (contains special characters other than underscore)
     *
     * @example
     ...
     * console.log(usernamePattern.test("(users)@name")); // false
     */
