...
const prepareEmailContent = (subject, emailData) => {
    ...
    switch (subject) {
        ...
        case 'Welcome Admin':
            ...
            preheaderText = 'You are now an admins!';
            heroSection = `
                <tr>
                  <td align="center" bgcolor="#e9ecef">
                    <!--[if (gte mso 9)|(IE)]>
        ...
        case 'Welcome Email':
            ...
            break;
        case 'Someone Dropped Us a Line':
            pageTitle = 'Someone Dropped Us a Line!';
            preheaderText = `A new message from ${emailData.name}!`;
            heroSection = `
                <tr>
                  <td align="center" bgcolor="#e9ecef">
                    <!--[if (gte mso 9)|(IE)]>
            ...
            mainSection = `
                <tr>
                  <td align="center" bgcolor="#e9ecef">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <h1 style="margin: 0 0 12px; font-size: 32px; font-weight: 400; line-height: 48px;">Hello ${emailData.name}!</h1>
                            <p style="margin: 0;">Thank you for reaching out to us. We have received the following details from you:</p>
                            <p><strong>Email:</strong> ${emailData.email}</p>
                            <p><strong>Phone:</strong> ${emailData.phone}</p>
                            <p><strong>Subject:</strong> ${emailData.subject}</p>
                            <p><strong>Message:</strong> ${emailData.message}</p>
                            <p>Please get back to ${emailData.email} as soon as possible.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
            ...
            footerContent = `
                <tr>
                    <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                      <p style="margin: 0;">You received this email because we received a new message from your site. If you didn't request your account you can safely delete this email.</p>
                    </td>
                </tr>
            `;

            break;
        case 'We have received your message':
            pageTitle = 'We have received your message!';
            preheaderText = `Thank you for reaching out, ${emailData.name}!`;
            heroSection = `
                <tr>
                  <td align="center" bgcolor="#e9ecef">
                    <!--[if (gte mso 9)|(IE)]>
                ...
                <tr>
                  <td align="center" bgcolor="#e9ecef">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <h1 style="margin: 0 0 12px; font-size: 32px; font-weight: 400; line-height: 48px;">Hi ${emailData.name}!</h1>
                            <p style="margin: 0;">Thank you for contacting us. We have received the following details from you:</p>
                            <p><strong>Email:</strong> ${emailData.email}</p>
                            <p><strong>Phone:</strong> ${emailData.phone}</p>
                            <p><strong>Subject:</strong> ${emailData.subject}</p>
                            <p><strong>Message:</strong> ${emailData.message}</p>
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                          <p style="margin: 0;">Best regards,<br> Library Management System</p>
                        </td>
                      </tr>
                      <!-- end copy -->
            ...
            footerContent = `
                <tr>
                    <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                      <p style="margin: 0;">You received this email because you contacted us through our site. If you did not initiate this request, please disregard this email.</p>
                    </td>
                </tr>
            `;
